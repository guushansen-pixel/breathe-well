<#
.SYNOPSIS
    Baut Breathe Well ueber apk-builder und patcht danach drei Dinge nach,
    die apk-builder selbst nicht unterstuetzt: Portrait-Lock, Keep-Screen-On
    und einen eigenen Predictive-Back-Handler fuer die Zurueck-Wischgeste.
.DESCRIPTION
